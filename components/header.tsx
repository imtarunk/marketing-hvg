      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <Button
              variant="ghost"
              className="text-foreground hover:bg-secondary/90 px-6 py-2 rounded-full font-medium shadow-sm"
            >
              Sign In
            </Button>
          </Link>
              ...
              <nav className="flex flex-col gap-4 mt-6">
                ...
                <div className="flex flex-col gap-2 mt-4">
                  ...
                  >
                    <Button
                      variant="ghost"
                      className="w-full text-foreground hover:bg-secondary/90 px-6 py-2 rounded-full font-medium shadow-sm"
                    >
                      Sign In
                    </Button>
                  </Link>
