      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          ...
          <p className="text-muted-foreground text-sm md:text-base font-medium leading-[18.20px] md:leading-relaxed break-words max-w-2xl">
            Join thousands of startups and investors already using Hubvestor to
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          >
            <Button
              variant="outline"
              className="px-[30px] py-2 text-base font-medium leading-6 rounded-[99px] shadow-[0px_0px_0px_4px_rgba(255,255,255,0.13)] transition-all duration-200"
              size="lg"
            >
              Sign In
            </Button>
